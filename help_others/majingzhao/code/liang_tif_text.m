clear
clc
[a,R]=geotiffread('G:\data_paper\new_anusplin\SPEI\SPEI-1\SPEI1.tif');%先导入投影信息，某个影像的路径就行（最好是你分析的数据中的一个）
info=geotiffinfo('G:\data_paper\new_anusplin\SPEI\SPEI-1\SPEI1.tif');%同上
[m,n]=size(a);
