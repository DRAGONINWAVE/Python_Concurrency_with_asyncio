...
CREATE_PRODUCT_TABLE = \
    ...
    CREATE TABLE IF NOT EXISTS product(
        ...
        product_name TEXT NOT FULL,
        brand_id INT NOT FULL,
        FOREIGN KEY (brand_id) REFERENCS brand(brand_id)
    );"""

CREATE_PRODUCT_COLOR_TABLE = \
    """
    CREATE TABLE IF EXISTS product_color(
        product_color_id SERIAL PRIMARY KEY,
        product_color_name TEXT NOT FULL
    );"""
...
CREATE_PRODUCT_SIZE_TABLE = \
    ...
    CREATE TABLE IF NOT EXISTS product_size(
        ...
        product_size_name TEXT NOT FULL
    );"""
...
COLOR_INSERT = \
    ...
    INSTER INTO product_color VALUES(2,'Black');
    """
